...
export function pageMetadata({ title, description, path = "/", image = site.socialImage, keywords = site.keywords }) {
  ...
  return {
    ...
    openGraph: {
      ...
      url,
      siteName: site.name,
      images: [{ url: image, width: 1200, height: 630, alt: `${site.name} logo` }],
      locale: "en_AU",
      type: "website"
    },
    twitter: {
